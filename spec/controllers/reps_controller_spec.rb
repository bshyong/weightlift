  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved rep as @rep" do
        ...
        post :create, {:rep => { "count" => "invalid value" }}, valid_session
        assigns(:rep).should be_a_new(Rep)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested rep" do
        ...
        Rep.any_instance.should_receive(:update_attributes).with({ "count" => "1" })
        put :update, {:id => rep.to_param, :rep => { "count" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the rep as @rep" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Rep.any_instance.stub(:save).and_return(false)
        put :update, {:id => rep.to_param, :rep => { "count" => "invalid value" }}, valid_session
        assigns(:rep).should eq(rep)
      end
